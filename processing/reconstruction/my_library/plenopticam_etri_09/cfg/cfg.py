...
from plenopticam_etri_09.misc.errors import PlenopticamError
from plenopticam_etri_09.misc.os_ops import mkdir_p
from plenopticam_etri_09.misc.type_checks import *
from plenopticam_etri_09.cfg.constants import PARAMS_KEYS, PARAMS_VALS, CALIBS_KEYS
...
class PlenopticamConfig(object):
    ...
    def reset_values(self):
        ...
        self.params[self.val_rota] = None
        self.params[self.img_rota] = None
