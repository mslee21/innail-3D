...
import sys
HOME = "./"
DATAHOME = "/home/mslee21/CaveHalley/[CodeCellar]/[2020-0-00168]/03-Research/23.11.24. (PM-V4-001) P1.0 depthTest/23.11.24_PM-V4-001_P1.0_h25um/reference/"
...
(cX, cY) = (w // 2, h // 2)
rot_angle = 0.2
M = cv2.getRotationMatrix2D((cX, cY),rot_angle, 0.85)
